...
const WHAT_YOU_GET = [
  "Full SA-AIRS(TM) score across all 5 dimensions with confidence ratings",
...
const STEPS = [
  {
    n: "01",
    title: "Book and pay",
    desc: "Rs 499. You receive the structured intake form immediately after payment.",
  },
  {
    n: "02",
...
const FAQS = [
  ...
  {
    q: "How is the SA-AIRS(TM) score calculated?",
    a: "Rule-based, not AI-generated. Your report is interpreted through a structured research method that considers role context, task exposure, market pressure, and judgment requirements. Scores include confidence language and clear limitations.",
  },
  {
  ...
  {
    q: "How is this different from the base SA-AIRS(TM) assessment?",
      ...
      <div style={{ background: "#0a1628", borderBottom: "1px solid #1e3a5f", padding: "14px 24px" }}>
        <div style={{ maxWidth: 680, margin: "0 auto", display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
          ...
          <span style={{ fontSize: 13, color: "#94a3b8", lineHeight: 1.5 }}>
            SA-AIRS(TM) is a rule-based career risk scoring system. This page lets you book a personal 48-hour audit - your role scored across 5 dimensions, placed on the Top 10% Ladder, with a 12 and 36-month risk horizon.
          </span>
        </div>
      </div>
      ...
      <section style={{ padding: "80px 24px 72px", borderBottom: "1px solid #e8edf5", background: "#f7f9fc" }}>
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.15em", textTransform: "uppercase", color: "#64748b", display: "block", marginBottom: 20 }}>
            SA-AIRS(TM) Career Risk Audit  -  India 2026
          </span>
          ...
          <p style={{ fontSize: 16, color: "#374151", lineHeight: 1.85, marginBottom: 40, maxWidth: 560 }}>
            The SA-AIRS(TM) audit scores your current role across five weighted dimensions, places you on the Top 10% Ladder, and tells you your risk horizon at{" "}
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 14, marginBottom: 48 }}>
            <CashfreeCheckout
              productName="SA-AIRS(TM) Career Risk Audit"
              amount={499}
              buttonLabel="Book the Audit - Rs 499 ->"
              accentColor="#0a1628"
        ...
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          ...
          <div style={{ border: "1px solid #e8edf5", padding: "40px 36px", background: "#ffffff" }}>
            <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", color: "#64748b", marginBottom: 20 }}>
              Full SA-AIRS(TM) Career Risk Audit
            </div>
            <div style={{ display: "flex", alignItems: "baseline", gap: 4, marginBottom: 16 }}>
              <span style={{ fontSize: 20, fontWeight: 700, color: "#0a1628" }}>Rs </span>
