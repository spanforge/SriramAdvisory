...
export const metadata: Metadata = {
  ...
  description:
    "India-first guide for Cloud Engineers navigating future-of-work infrastructure shifts. Includes role-risk clarity, a 90-day transition direction, stronger positioning guidance, and practical next steps. Rs 499.",
};
