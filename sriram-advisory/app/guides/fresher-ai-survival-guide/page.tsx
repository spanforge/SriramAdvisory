...
export const metadata: Metadata = {
  ...
  description:
    "India-first guide for freshers navigating future-of-work entry-level hiring. Includes first-job positioning, AI tool-use direction, proof-building guidance, and practical next steps. Rs 499.",
};
