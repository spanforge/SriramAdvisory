...
export const metadata: Metadata = {
  ...
  description:
    "India-first transition guide for FDE professionals navigating future-of-work career shifts. Includes role-risk clarity, a 90-day transition direction, stronger positioning guidance, and practical next steps. Rs 499.",
};
