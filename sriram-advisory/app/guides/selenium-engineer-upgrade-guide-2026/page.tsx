...
export const metadata: Metadata = {
  ...
  description:
    "India-first guide for Selenium engineers navigating the Playwright and future-of-work shift. Includes upgrade direction, stronger automation positioning, and practical next steps. Rs 499.",
};
