...
export const metadata: Metadata = {
  ...
  description:
    "Public overview of the Sriram Advisory frameworks used to interpret role exposure, career durability, AI leverage, and professional positioning.",
};
      ...
      >
        <div style={{ maxWidth: 980, margin: "0 auto", padding: "0 24px" }}>
          ...
          <h1 style={{ fontSize: "clamp(38px, 5.4vw, 68px)", fontWeight: 900, color: "#0a1628", lineHeight: 1.08, margin: "0 0 24px", letterSpacing: "-0.02em" }}>
            Named models for interpreting how work is changing.
          </h1>
          <p style={{ fontSize: "clamp(17px, 2.1vw, 21px)", color: "#4a5a7a", lineHeight: 1.75, maxWidth: 780, margin: 0 }}>
            These public pages explain the purpose, examples, and limits of Sriram Advisory&apos;s frameworks. The detailed rubrics remain proprietary and are applied inside reports, assessments, and advisory work.
          </p>
        </div>
      </section>
        ...
        <div style={{ maxWidth: 1180, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 18 }}>
          {FRAMEWORK_ITEMS.map((framework) => (
            <Link key={framework.slug} href={`/frameworks/${framework.slug}`} style={{ textDecoration: "none" }}>
              <article style={{ height: "100%", border: "1px solid #dbe5f5", borderRadius: 8, padding: "26px 24px", background: "#f8fbff" }}>
      ...
      <section style={{ padding: "92px 24px", background: "#0a1628", color: "#ffffff", textAlign: "center" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 17, lineHeight: 1.8, color: "#dbe7ff", margin: "0 0 30px" }}>
            Start with the research method for how these models are developed and updated.
          </p>
          <Link href="/methodology" style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", padding: "15px 28px", borderRadius: 8, background: "#ffffff", color: "#1a4fd6", textDecoration: "none", fontWeight: 900 }}>
