...
export const metadata: Metadata = {
  ...
  description:
    "Research-backed AI career intelligence for Indian professionals. 47+ roles, 7 sectors, salary scenarios, AI tools by profession, and a 90-day roadmap. ₹999.",
};
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 760, margin: "0 auto", padding: "0 20px" }}>
          ...
          <p style={{ marginTop: 20, fontSize: 13, color: "rgba(168,196,255,0.85)" }}>
            ₹999 · One-time purchase · Instant digital delivery · Quarterly updates included
          </p>
        </div>
      </section>
      ...
      <section style={{ padding: "80px 20px", background: "#f0f5ff", textAlign: "center" }}>
        <div style={{ maxWidth: 600, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 17, color: "#5a6a8a", lineHeight: 1.6, marginBottom: 36 }}>
            ₹999. One-time purchase. Instant digital delivery. Includes two quarterly update editions through December 2026.
          </p>
          <CashfreeCheckout
            productName="AI Career Intelligence Report — Pro Edition"
            amount={999}
