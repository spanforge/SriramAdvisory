...
const WHAT_YOU_GET = [
  ...
  },
  {
    ...
    desc: "The report highlights the categories of shifts that matter, without giving away the full report logic on the page itself.",
  },
];
        ...
        <div style={{ maxWidth: 980, margin: "0 auto", padding: "0 20px", position: "relative" }}>
          ...
          >
            <div>
              ...
              >
                This page is intentionally selective. It shows the shape of the report, not the report itself.
              </p>
              <div style={{ display: "flex", flexWrap: "wrap", gap: 12 }}>
                {[
                  "Premium paid report",
                  "Limited preview on-page",
            ...
            >
              ...
              <p style={{ fontSize: 13, color: "rgba(235,255,248,0.78)", lineHeight: 1.6, margin: "0 0 18px" }}>
                Limited launch pricing for the first release. The landing page stays selective so the value remains inside the paid report.
              </p>
              <CashfreeCheckout
      ...
      >
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 17, lineHeight: 1.75, color: "rgba(235,255,248,0.84)", marginBottom: 32 }}>
            The full value is inside the report. This page is deliberately restrained so the purchase unlocks the actual advantage.
          </p>
